...
<div class="mt-3">
	<table class="table table-bordered table-hover table-sm">
		...
		<?php
		if (empty($data)) {
			echo "<tr><td colspan='4'>belum ada data, <a href='".base_url()."admin/".$url."/edit/0'>buat baru</a></td></tr>";
		} else {
		...
		?>
			<tr>
				...
				<td class="text-center">
					<a href="<?php echo base_url('admin/'.$url.'/edit/'.$d['UserId']); ?>" class="badge badge-success"><i class="fa fa-pencil"></i> Edit</a>
					<a href="<?php echo base_url('admin/'.$url.'/hapus/'.$d['UserId']); ?>" class="badge badge-danger" onclick="return confirm('Anda yakin..?');"><i class="fa fa-times"></i> Hapus</a>
				</td>
			</tr>
		<?php
			}
