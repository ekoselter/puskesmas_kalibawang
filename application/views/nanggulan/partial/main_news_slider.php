			...
			<div id="owl-slider<?=$id_slider;?>" class="owl-carousel owl-theme">
				...
				if (!empty($data['data'])) {
					foreach ($data['data'] as $b) {
						$img = is_file($this->config->item('base_url_file')."news/thumb/".$b['gambar']) ? '<img src="'.config_item('base_url_file_url')."news/thumb/".$b['gambar'].'" alt="" class="img-responsive">' : '<img src="'.base_url('aset/no_pict.png').'" alt="" class="img-responsive">';
					...
					<div class="slider-post post-height-1">
						...
						<div class="post-text">
							...
							<ul class="authar-info">
								...
								<li class="date"><?=tjs($b['create_at']);?></li>
