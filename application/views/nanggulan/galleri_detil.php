...
if (empty($gambar_background['background-image'])) {
    ...
    $gambar_bg = base_url().str_replace("./", "", $this->config->item('base_url_file')).'img_background/'.$gambar_background['background-image-raw-path'];
}
?>
				...
				<div class="container">
					<div class="row row-m">
						<div class="col-sm-8 main-content col-p" style="margin-top: 10px">
							<div class="">
								<?php $this->load->view($this->config->item('template') . '/partial/main_galleri_detil', $main['galleri']);?>
							</div>
						</div>
						<!-- KANAN -->
						<div class="col-md-4">
