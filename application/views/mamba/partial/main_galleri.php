    ...
    <div class="news-body">
        ...
        if (!empty($detil)) {
            ...
            foreach ($detil as $dtl) {
                ...
                echo '</div><div class="card-footer text-center"><a href="'.base_url('galleri-detil/'.$dtl['id'].'/'.url_title($dtl['name'],'-',true)).'" class="text-info" style="font-size: 10pt">'.$dtl['name'].'</a></div></div></div>'."\n";
                if (($jml%3) == 0) {
