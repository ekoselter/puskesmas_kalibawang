...
<html lang="en">
	...
	<body style="background: url('<?=$gambar_bg;?>'); background-color: <?=$gambar_background['background-color'];?>; background-size: contain">
		...
		<main class="page_main_wrapper">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <ol class="breadcrumb" style="float: none !important">
                                ...
                                <li class="active"><a href="#">Galleri Foto</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
			...
			<section class="articles-wrapper" style="margin-top: 20px">
				<div class="container">
					<div class="row row-m">
						<div class="col-sm-8 main-content col-p">
							<div class="">
								<?php $this->load->view($this->config->item('template') . '/partial/main_galleri', $main['galleri']);?>
							</div>
						</div>
						<!-- KANAN -->
						<div class="col-md-4">
